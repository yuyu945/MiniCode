...
def _win_has_any_input() -> bool:
    """Check for ANY console input events on Windows (keyboard + mouse)."""
    ...
    try:
        ...
        if kernel32.GetNumberOfConsoleInputEvents(h_in, ctypes.byref(count)):
